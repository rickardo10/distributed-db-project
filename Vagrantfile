...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    config.vm.define "config01" do |config01| 
        ...
        config01.vm.provision "shell", path: "scripts/general.sh"
    ...
    config.vm.define "query01" do |query01| 
        ...
        query01.vm.provision "shell", path: "scripts/general.sh"
    ...
    config.vm.define "shard02" do |shard02| 
        ...
        shard02.vm.provision "shell", path: "scripts/general.sh"
        shard02.vm.provision "shell", path: "scripts/replica.sh"
    ...
    config.vm.define "shard01" do |shard01| 
        ...
        shard01.vm.provision "shell", path: "scripts/general.sh"
        shard01.vm.provision "shell", path: "scripts/replica.sh"
        shard01.vm.provision "shell", path: "scripts/master.sh"
    ...
    config.vm.define "shard03" do |shard03| 
        ...
        shard03.vm.provision "shell", path: "scripts/general.sh"
